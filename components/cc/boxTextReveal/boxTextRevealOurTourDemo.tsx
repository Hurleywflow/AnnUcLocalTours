		...
		<div className='h-fit w-full items-center justify-center overflow-hidden '>
			<BoxReveal boxColor='#9ed6f9b6' duration={0.5}>
				<P className='text-pretty tracking-normal md:px-5 lg:px-10'>
					...
					<span className='font-bold text-primary'>* </span>{" "}
					{pathname.includes("/vi")
						? "Ngoài các tour du lịch của chúng tôi, chúng tôi cung cấp một loạt các dịch vụ bao gồm đưa đón sân bay, cho thuê xe hơi có tài xế và các lựa chọn giao thông từ ô tô nhỏ đến xe buýt lớn. Chúng tôi cũng cung cấp thiết kế hành trình du lịch theo yêu câu, hướng dẫn viên du lịch chuyên nghiệp ở Úc và tổ chức sự kiện bao gồm các bữa tiệc. Chúng tôi rất vui mừng thông báo các tour du lịch mới đến Bali (Indonesia), Thái Lan, Việt Nam, Nhật Bản, Hàn Quốc, Mỹ, Châu Âu và New Zealand, phù hợp cho những người sống hoặc đi du lịch từ Úc."
					...
					<span className='font-bold text-primary'>* </span>
					{pathname.includes("/vi")
						? "Luôn cập nhật về các điểm đến của chúng tôi, nhận đề xuất hành trình và nhận thông tin du lịch mới nhất bằng cách theo dõi và thích trang Facebook của chúng tôi tại"
