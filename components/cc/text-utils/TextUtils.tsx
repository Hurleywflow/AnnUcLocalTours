...
export function P({
	...
	return (
		<p
			className={cn(
				" text-center text-balance text-base font-normal  md:text-lg lg:text-xl",
				className,
			)}
		>
			{children}
...
export function PShadow({
	...
	return (
		<p
			className={cn(
				" p-1 text-center text-balance text-base font-normal md:text-lg lg:text-xl shadow-foreground  text-shadow-sm",
				className,
			)}
		>
			{children}
...
export function SpanShadow({
	...
	return (
		<span
			className={cn(
				" p-1 text-center text-balance text-sm font-normal md:text-base lg:text-lg shadow-foreground  text-shadow-sm",
				className,
			)}
		>
			{children}
