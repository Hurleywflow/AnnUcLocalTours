...
export const ToursOtherCountries: TourType[] = [
	...
	{
		id: "ja4",
		title: "Japan - April and November every year",
		subTitle: [
			{
				id: "ja4.1",
				...
				departs: "November 2024, April 2025, November 2025",
				schedule: [
					"Tour includes: ",
					...
					"",
					"DAY 1: FLY FROM SYDNEY TO TOKYO",
					...
					"DAY 7: RETURNS AT SYDNEY AIRPORT.",
					"",
					...
					"Private tours can be arranged for groups of eight or more.",
...
export const ToursOtherCountriesVi: TourType[] = [
	...
	{
		id: "ja4",
		title: "Japan - Tháng 4 và Tháng 11 hàng năm",
		subTitle: [
			{
				id: "ja4.1",
				...
				departs: "Tháng 11/2024, 04/2025, 11/2025",
				schedule: [
					"Tour đã bao gồm: ",
					...
					"",
					"NGÀY 1:  BAY TỪ SYDNEY ĐẾN TOKYO",
