...
export const ToursAustraliaVi: TourType[] = [
	{
		...
		description: [
			...
			"Sydney tự hào có những địa danh mang tính biểu tượng như Nhà hát Opera Sydney và Cầu Cảng Sydney. Đường bờ biển có những bãi biển tuyệt đẹp như Bondi và Manly, cũng như những lối đi dạo ven biển đẹp như tranh vẽ. Thành phố có nền văn hóa thịnh vượng với các phòng trưng bày nghệ thuật, bảo tàng và các buổi biểu diễn trực tiếp . Bạn sẽ tìm thấy những công viên và khu vườn tươi tốt như Vườn Bách thảo Hoàng gia và Công viên Centennial. Các điểm tham quan thú vị bao gồm Sở thú Taronga và nhiều hoạt động ngoài trời đa dạng, bao gồm các món ăn ngon, chợ hải sản và ẩm thực đa văn hóa. đến nhiều lễ hội và sự kiện khác nhau trong suốt cả năm, đồng thời nơi đây nổi tiếng với sự thân thiện của người dân địa phương và bầu không khí quốc tế.",
			"Sydney là điểm đến mang đến sự kết hợp hoàn hảo giữa các địa danh mang tính biểu tượng, vẻ đẹp tự nhiên, văn hóa sôi động và các hoạt động thú vị. Cho dù bạn háo hức khám phá những thắng cảnh nổi tiếng thế giới, thư giãn trên những bãi biển tuyệt đẹp, đắm mình trong nghệ thuật hay đam mê các hoạt động nghệ thuật đồ ăn ngon, Sydney có thứ gì đó dành cho mọi nhà thám hiểm. Vì vậy, hãy chuẩn bị trải nghiệm sự kỳ diệu của Sydney và tìm hiểu lý do tại sao đây là một trong những thành phố quyến rũ nhất thế giới!",
		],
		imageUrl: [
			"/Images/tours/sydney/1.jpg",
			"/Images/tours/sydney/2.jpg",
	...
	},
	{
		...
		description: [
			"Melbourne, Úc, là một thành phố thú vị và sôi động, kết hợp hoàn hảo giữa văn hóa, vẻ đẹp tự nhiên và các điểm tham quan ly kỳ. Cho dù bạn đam mê nghệ thuật, ẩm thực, thiên nhiên hay phiêu lưu, Melbourne đều có thứ gì đó dành cho bạn. Đây là lý do Melbourne nên là nơi dành cho bạn điểm đến phiêu lưu tiếp theo:",
			"Melbourne nổi tiếng với nền văn hóa và nghệ thuật đa dạng, tự hào với các phòng trưng bày nghệ thuật, nhà hát và địa điểm âm nhạc. Thành phố này là thiên đường ẩm thực với khung cảnh ẩm thực và cà phê thượng hạng, cung cấp nhiều lựa chọn ăn uống và văn hóa cà phê nổi tiếng Hơn nữa, Melbourne còn tự hào có những công viên và khu vườn tuyệt đẹp, những điểm tham quan và hoạt động thú vị, bờ biển quyến rũ và những chuyến đi đẹp như tranh vẽ. Thành phố tổ chức các lễ hội và sự kiện sôi động quanh năm và có bầu không khí thân thiện, mang tính quốc tế với người dân địa phương thân thiện và phương tiện giao thông công cộng hiệu quả.",
			"Melbourne là điểm đến kết hợp giữa sự phong phú về văn hóa, thú vui ẩm thực, vẻ đẹp tự nhiên và các hoạt động thú vị. Cho dù bạn muốn đắm mình trong nghệ thuật, thưởng thức ẩm thực đẳng cấp thế giới, khám phá cảnh quan tuyệt đẹp hay thưởng thức các lễ hội sôi động, Melbourne đều có thứ gì đó dành cho mọi người. nhà thám hiểm. Vì vậy, hãy đóng gói hành lý của bạn và sẵn sàng khám phá lý do tại sao Melbourne nổi bật là một trong những thành phố năng động và quyến rũ nhất nước Úc!",
		],
		imageUrl: [
			"/Images/tours/melbourne/1.jpg",
			"/Images/tours/melbourne/2.jpg",
	...
	},
	{
		...
		title: "Adelaide",
		description: [
			"Adelaide, thủ đô thú vị của Nam Úc, thường không được chú ý mặc dù đây là một kho tàng vẻ đẹp tự nhiên, nền văn hóa phong phú và những trải nghiệm khó quên. Đây là lý do tại sao việc xem xét Adelaide cho chuyến phiêu lưu tiếp theo của bạn là một ý tưởng tuyệt vời:",
			"Adelaide tự hào có khung cảnh ngoạn mục và vẻ đẹp tự nhiên, bao gồm những bãi biển hoang sơ, cảnh quan tươi tốt và những khu vườn thanh bình. Thành phố ngập tràn văn hóa và di sản, có các phòng trưng bày nghệ thuật, bảo tàng và di tích lịch sử để khám phá. Đây cũng là trung tâm sản xuất rượu vang hảo hạng và những trải nghiệm dành cho người sành ăn, bao gồm các vùng rượu vang gần đó và khung cảnh ăn uống đa dạng. Du khách có thể tham gia vào các điểm tham quan và hoạt động thú vị, chẳng hạn như gặp gỡ động vật hoang dã, phiêu lưu ngoài trời và các lễ hội sôi động quanh năm. Được biết đến với lối sống thoải mái và người dân địa phương. là một thành phố thân thiện và thú vị để khám phá.",
			"Adelaide là điểm đến kết hợp hoàn hảo giữa vẻ đẹp tự nhiên, văn hóa phong phú, rượu vang đẳng cấp thế giới và các điểm tham quan thú vị. Cho dù bạn đang tìm kiếm sự thư giãn trên bãi biển, khám phá những vườn nho tươi tốt hay hòa mình vào các lễ hội sôi động, Adelaide đều mang lại điều gì đó cho mọi nhà thám hiểm Vì vậy, hãy chuẩn bị hành lý và khám phá lý do tại sao Adelaide nổi bật là một trong những điểm đến quyến rũ và đa dạng nhất nước Úc!",
		],
		imageUrl: [
			"/Images/tours/adelaide/1.jpg",
			"/Images/tours/adelaide/2.jpg",
	...
	// },
	{
		...
		description: [
			...
			"Gold Coast có những bãi biển ngoạn mục, công viên giải trí ly kỳ và trải nghiệm động vật hoang dã đa dạng. Du khách có thể khám phá những khu rừng nhiệt đới tươi tốt của Hinterland, thưởng thức các môn thể thao dưới nước và tận hưởng cuộc sống về đêm sôi động. Khu vực này cũng tự hào có khung cảnh văn hóa phong phú, đồ ăn ngon và rượu vang , đồng thời tổ chức nhiều lễ hội và sự kiện khác nhau quanh năm. Người dân địa phương thân thiện và bầu không khí thoải mái khiến Gold Coast trở thành điểm đến thân thiện với du khách.",
			"Gold Coast là điểm đến mang đến sự kết hợp hoàn hảo giữa vẻ đẹp tự nhiên, các điểm tham quan ly kỳ, văn hóa phong phú và cuộc sống về đêm sôi động. Cho dù bạn muốn thư giãn trên bãi biển, tìm kiếm các hoạt động kích thích cảm giác mạnh hay hòa mình vào văn hóa địa phương , Gold Coast luôn có điều gì đó dành cho mọi nhà thám hiểm. Vì vậy, hãy sẵn sàng cho một chuyến phiêu lưu khó quên và khám phá lý do tại sao Gold Coast lại là một trong những điểm đến hàng đầu của Úc!",
		],
		imageUrl: [
			"/Images/tours/gold-coast/1.jpg",
			"/Images/tours/gold-coast/2.jpg",
	...
	// },
	{
		...
		title: "Perth",
		description: [
			"Perth, Úc, là điểm đến đặc biệt cho bất kỳ nhà thám hiểm nào đang tìm kiếm sự kết hợp giữa vẻ đẹp tự nhiên, văn hóa sôi động và các điểm tham quan độc đáo. Đây là lý do bạn nên xách ba lô lên và đến thành phố tuyệt đẹp này:",
			"Perth, Australia có khung cảnh ngoạn mục và vẻ đẹp tự nhiên, với cơ hội tham gia các hoạt động dưới nước và cảnh hoàng hôn tuyệt đẹp tại các bãi biển như Cottesloe và Scarborough. Thành phố cũng tự hào có tấm thảm văn hóa phong phú, kết hợp di sản bản địa với cuộc sống hiện đại của Úc thông qua các khung cảnh nghệ thuật và văn hóa sôi động.",
			"Các tổ chức thám hiểm có thể tận hưởng cuộc sống hoang dã tại Đảo Rottnest, các chuyến tham quan nếm rượu vang ở Thung lũng Swan và các hoạt động kích thích cảm giác mạnh như nhảy dù và lướt sóng. Perth tổ chức nhiều lễ hội và sự kiện trong suốt cả năm, bao gồm Lễ hội Perth và Lễ hội Taste Great Southern. Bầu không khí thân thiện, thoải mái, lòng hiếu khách nồng hậu và môi trường an toàn của thành phố khiến nơi đây trở thành một nơi lý tưởng để ghé thăm.",
			"Perth là điểm đến mang đến sự kết hợp hoàn hảo giữa vẻ đẹp tự nhiên, văn hóa phong phú, các điểm tham quan ly kỳ và bầu không khí thân thiện. Cho dù bạn muốn thư giãn trên bãi biển, khám phá cảnh quan đa dạng hay hòa mình vào văn hóa địa phương, Perth đều có điều gì đó dành cho mọi nhà thám hiểm. Vậy tại sao phải chờ đợi? Hãy bắt đầu lên kế hoạch cho chuyến phiêu lưu khó quên của bạn đến Perth ngay hôm nay!",
		],
		imageUrl: [
			"/Images/tours/perth/1.jpg",
			"/Images/tours/perth/2.jpg",
	...
	},
	{
		...
		title: "Tasmania",
		description: [
			"Tasmania, quốc đảo của Úc, là một viên ngọc ẩn mang đến chuyến phiêu lưu tuyệt vời với vùng hoang dã nguyên sơ, lịch sử phong phú và nền văn hóa sôi động. Đây là lý do Tasmania nên là điểm đến du lịch tiếp theo của bạn:",
			"Tasmania có vẻ đẹp tự nhiên tuyệt đẹp, bao gồm các khu vực hoang dã Di sản Thế giới và các công viên quốc gia mang tính biểu tượng như Núi Cradle-Hồ St Clair và Freycinet. Hòn đảo này là nơi sinh sống của các loài động vật hoang dã độc đáo như quỷ Tasmania và tự hào có lịch sử và văn hóa phong phú, với sự pha trộn giữa Lịch sử kết án và di sản ẩm thực bản địa có rất nhiều thú vị, với dịch vụ ăn uống từ trang trại đến bàn ăn, nhà máy rượu vang nổi tiếng và các sản phẩm thủ công có thể tận hưởng việc đi bộ đường dài, chèo thuyền kayak và ngắm động vật hoang dã, trong khi hòn đảo tổ chức các lễ hội và sự kiện độc đáo như MONA FOMA và Taste. của Tasmania. Người Tasmania được biết đến với lòng hiếu khách nồng hậu và sự thân thiện, đồng thời các khu chợ địa phương là cách tuyệt vời để trải nghiệm những sản phẩm và hàng thủ công tuyệt vời nhất của Tasmania.",
			"Tasmania mang đến sự pha trộn độc đáo giữa vẻ đẹp thiên nhiên tuyệt đẹp, lịch sử phong phú, văn hóa sôi động và ẩm thực ngon miệng. Cho dù bạn là người đam mê hoạt động ngoài trời, người yêu thích lịch sử, người thích ẩm thực hay chỉ đơn giản là tìm kiếm một lối thoát thanh thản, Tasmania đều có thứ gì đó để cung cấp. hành lý của bạn và sẵn sàng khám phá những điều kỳ diệu của hòn đảo đáng kinh ngạc này!",
		],
		imageUrl: [
			"/Images/tours/tasmania/1.jpg",
			"/Images/tours/tasmania/2.jpg",
	...
	},
	{
		...
		description: [
			"Uluru, còn được gọi là Ayers Rock, là một trong những địa danh tự nhiên mang tính biểu tượng và đầy cảm hứng nhất của Úc. Nằm ở trung tâm Lãnh thổ phía Bắc, khối đá sa thạch khổng lồ này có ý nghĩa văn hóa sâu sắc đối với người Anangu, những người bảo vệ truyền thống của vùng đất . Đến thăm Uluru mang đến sự kết hợp độc đáo giữa vẻ đẹp tự nhiên, nền văn hóa thổ dân phong phú và những trải nghiệm khó quên. Đây là lý do bạn nên cân nhắc việc biến Uluru thành điểm đến phiêu lưu tiếp theo của mình:",
			"Uluru là một đặc điểm địa chất độc đáo với độ cao 348m và sự thay đổi màu sắc ấn tượng. Nằm cách Uluru 25km về phía tây, Kata Tjuta có cảnh quan tuyệt đẹp. Uluru có ý nghĩa tâm linh đối với người Anangu và các chuyến tham quan văn hóa mang đến cái nhìn sâu sắc về những câu chuyện và truyền thống của Dreamtime. Du khách có thể trải nghiệm cảnh bình minh và hoàng hôn huyền diệu, chứng kiến ​​màu sắc rực rỡ của Cánh đồng ánh sáng sau khi trời tối và khám phá khu vực trên các chuyến tham quan bằng lạc đà. Sa mạc xung quanh Uluru là nơi có hệ động thực vật độc đáo, với nhiều cơ hội ngắm nhìn động vật hoang dã và ngắm chim. từ những khu nghỉ dưỡng sang trọng đến những lựa chọn vừa túi tiền, tất cả đều mang lại trải nghiệm văn hóa và ẩm thực cao cấp.",
			"Uluru mang đến trải nghiệm du lịch độc đáo và khó quên, kết hợp vẻ đẹp thiên nhiên ngoạn mục, văn hóa thổ dân phong phú cùng hàng loạt hoạt động và cuộc phiêu lưu. Cho dù bạn đang ngắm bình minh trên tảng đá mang tính biểu tượng, khám phá nghệ thuật trên đá cổ xưa hay tìm hiểu về truyền thống của Với người Anangu, Uluru hứa hẹn sẽ là một hành trình khám phá và kỳ thú. Vì vậy, hãy chuẩn bị hành lý và sẵn sàng khám phá một trong những điểm đến thiêng liêng và quý giá nhất của Úc, Uluru.",
		],
		imageUrl: [
			"/Images/tours/uluru/1.jpg",
			"/Images/tours/uluru/2.jpg",
	...
	},
	{
		...
		description: [
			...
			"Dãy Blue Mountains mang đến sự kết hợp độc đáo giữa vẻ đẹp tự nhiên, văn hóa phong phú và các hoạt động mạo hiểm. Cho dù bạn đang tìm kiếm một nơi trú ẩn yên bình trên núi, khám phá những cảnh quan tuyệt đẹp hay dấn thân vào một cuộc phiêu lưu ly kỳ, Blue Mountains đều có thứ gì đó dành cho mọi người.",
			"Vì vậy, hãy chuẩn bị hành lý và sẵn sàng khám phá Blue Mountains cũng như khám phá lý do tại sao nơi đây là một trong những điểm đến đẹp và đa dạng nhất thế giới!",
		],
		imageUrl: [
			"/Images/tours/blue-mt/1.jpg",
			"/Images/tours/blue-mt/2.jpg",
	...
	},
	{
		...
		description: [
			"Khám phá sự kết hợp hoàn hảo giữa cảnh quan ven biển tuyệt đẹp, văn hóa địa phương sôi động và các hoạt động thú vị ở Bãi biển Wollongong và Kiama, New South Wales, Australia. Những điểm đến này có điều gì đó dành cho tất cả mọi người, cho dù bạn muốn thư giãn trên những bãi biển hoang sơ, khám phá những vách đá ấn tượng hay đắm mình trong sự quyến rũ của địa phương.",
			"Wollongong tự hào có những bãi biển đa dạng như Bãi biển Bắc Wollongong, cung cấp các tiện nghi thân thiện với gia đình, Bãi biển Thành phố để thuận tiện trong đô thị và bầu không khí thư giãn của Bãi biển Austinmer, hoàn hảo để lặn với ống thở. Những người tìm kiếm phiêu lưu có thể tận hưởng môn nhảy dù, lướt ván ở Bald Hill hoặc lướt trên những con sóng địa phương Các điểm tham quan văn hóa bao gồm Đền Nan Tien, Vườn Bách thảo Wollongong và Phòng trưng bày Nghệ thuật.",
			"Kiama nổi tiếng với các kỳ quan thiên nhiên như Kiama Blowhole và Cathedral Rocks, những con đường đi bộ thơ mộng như Kiama Coast Walk và Rừng mưa nhiệt đới Minnamurra, cùng nét quyến rũ của địa phương với các điểm tham quan như Ngọn hải đăng Kiama và Chợ Nông sản. Chỗ ở đa dạng, từ khu nghỉ dưỡng bên bờ biển đến nhà nghỉ kiểu boutique và lựa chọn cắm trại. ",
			...
			"trải nghiệm khó quên. Vì vậy, hãy chuẩn bị hành lý và sẵn sàng khám phá những điều kỳ thú của Bãi biển Wollongong và Kiama ở New South Wales!",
		],
		imageUrl: [
			"/Images/tours/wollongong-kiama/1.jpg",
			"/Images/tours/wollongong-kiama/2.jpg",
