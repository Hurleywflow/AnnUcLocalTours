...
export const blogData: BlogType[] = [
	{
		...
		description: [
			...
			"The Australian National University (ANU) is renowned for its research excellence, and the CSIRO Discovery Centre provides interactive exhibits on scientific advancements.",
